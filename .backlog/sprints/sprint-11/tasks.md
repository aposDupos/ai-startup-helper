...
**Критерии приёмки:**
- [x] Урок с `{{project.title}}` показывает реальное название проекта
- [x] Если проекта нет → fallback "твой проект"
- [x] Минимум 3 урока используют template variables
- [x] Персонализация работает и в micro, и в full уроках
...
**Критерии приёмки:**
- [x] Вопрос "что такое CustDev?" → AI объясняет + предлагает урок
- [x] Ссылка на урок кликабельна и открывает правильную страницу
- [x] Рекомендация контекстная (основана на стадии проекта)
...
**Критерии приёмки:**
- [x] Quiz показывает вопрос с данными из проекта
- [x] Reflection-тип: нет правильного ответа, принимает любой
- [x] Open-тип: сравнивает с реальными данными проекта
- [x] Без проекта → fallback на generic quiz
